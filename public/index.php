  ...
  <section class="home-conts__item" id="realizing">
    ...
    <div class="home-conts__inner realizing">
      <div class="home-conts__bg">
        <video autoplay loop poster="<?php echo $img_url; ?>/home/xxx.png" class="home-conts__video">
          <source src="<?php echo $img_url; ?>/home/realizing.mp4" type="video/mp4">
        </video>
    ...
    <section class="home-conts__item" id="mixed">
      <div class="home-conts__inner mixed">
        ...
        <div class="home-conts__bg">
          <video autoplay loop poster="<?php echo $img_url; ?>/home/xxx.png" class="home-conts__video">
            <source src="<?php echo $img_url; ?>/home/mixed.mp4" type="video/mp4">
          </video>
          <div class="home-conts__dot"></div>
        </div>
        <header class="home-conts__head">
    ...
    <section class="home-conts__item" id="mobility">
      <div class="home-conts__inner mobility">
        <div class="home-conts__bg">
          <video autoplay loop poster="<?php echo $img_url; ?>/home/xxx.png" class="home-conts__video">
            <source src="<?php echo $img_url; ?>/home/mobility.mp4" type="video/mp4">
          </video>
          <div class="home-conts__dot"></div>
        </div>
        <header class="home-conts__head">
    ...
    <section class="home-conts__item" id="sensing">
      <div class="home-conts__inner sensing">
        <div class="home-conts__bg">
          <video autoplay loop poster="<?php echo $img_url; ?>/home/xxx.png" class="home-conts__video">
            <source src="<?php echo $img_url; ?>/home/sensing.mp4" type="video/mp4">
          </video>
          <div class="home-conts__dot"></div>
        </div>
        <header class="home-conts__head">
